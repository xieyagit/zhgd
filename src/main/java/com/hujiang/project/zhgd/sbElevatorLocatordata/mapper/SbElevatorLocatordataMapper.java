package com.hujiang.project.zhgd.sbElevatorLocatordata.mapper;
 ...
 * @date 2019-09-11
 */
public interface SbElevatorLocatordataMapper 
{
	/**
     * 查询升降机GPS定位数据
信息
...
ID
     * @return 结果
     */
	public int deleteSbElevatorLocatordataById(Integer id);
