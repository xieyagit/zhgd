package com.hujiang.project.zhgd.sbGroupTalkback.ziputil;
...
public class Zip {
    ...
    //阿里云API的bucket路径
    private static final String urlPrefix = "http://hujiang.oss-cn-shenzhen.aliyuncs.com";
    ...
    public static  String uploadObject2OSS(OSSClient ossClient, File file, String bucketName, String folder) {
        ...
        try {
            ...
            metadata.setContentDisposition("filename/filesize=" +  new String(fileName.getBytes("GBK"), "ISO8859_1") + "/" + fileSize + "Byte.");
            //上传文件   (上传文件流的形式)
            ...
            //上传图片的路径
            url = ossClient.generatePresignedUrl(bucketName, folder + fileName, dates).toString();
