...
public class HjConstructionCompanyServiceImpl implements IHjConstructionCompanyService {
    ...
    @Override
    public ConstructionCompany selectConstruction(Integer projectId) {
        return hjConstructionCompanyMapper.selectConstruction(projectId);

    }

    @Override
    public ConstructionCompany selectSupervisor(Integer projectId) {
        return hjConstructionCompanyMapper.selectSupervisor(projectId);
    }
}
