package com.hujiang.project.zhgd.hjSafetyProblemgrade.mapper;
 ...
 * @date 2019-07-10
 */
public interface HjSafetyProblemgradeMapper 
{
	/**
     * 查询问题级别信息
     * 
     ...
     * @return 结果
     */
	public int deleteHjSafetyProblemgradeById(Integer id);
