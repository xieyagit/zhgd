package com.hujiang.project.zhgd.jpush.api;
...
import com.hujiang.project.zhgd.jpush.api.device.AliasDeviceListResult;
import com.hujiang.project.zhgd.jpush.api.device.DeviceClient;
import com.hujiang.project.zhgd.jpush.api.device.OnlineStatus;
import com.hujiang.project.zhgd.jpush.api.device.TagAliasResult;
import com.hujiang.project.zhgd.jpush.api.device.TagListResult;
import com.hujiang.project.zhgd.jpush.api.push.CIDResult;
import com.hujiang.project.zhgd.jpush.api.push.PushClient;
import com.hujiang.project.zhgd.jpush.api.push.PushResult;
import com.hujiang.project.zhgd.jpush.api.push.model.Message;
import com.hujiang.project.zhgd.jpush.api.push.model.Platform;
import com.hujiang.project.zhgd.jpush.api.push.model.PushPayload;
import com.hujiang.project.zhgd.jpush.api.push.model.SMS;
import com.hujiang.project.zhgd.jpush.api.push.model.audience.Audience;
import com.hujiang.project.zhgd.jpush.api.push.model.notification.IosAlert;
import com.hujiang.project.zhgd.jpush.api.push.model.notification.Notification;
import com.hujiang.project.zhgd.jpush.api.report.*;
import com.hujiang.project.zhgd.jpush.api.report.model.CheckMessagePayload;
import com.hujiang.project.zhgd.jpush.api.schedule.JPushScheduleResult;
import com.hujiang.project.zhgd.jpush.api.schedule.ScheduleClient;
import com.hujiang.project.zhgd.jpush.api.schedule.ScheduleListResult;
import com.hujiang.project.zhgd.jpush.api.schedule.ScheduleMsgIdsResult;
import com.hujiang.project.zhgd.jpush.api.schedule.model.SchedulePayload;
import com.hujiang.project.zhgd.jpush.api.schedule.model.TriggerPayload;
import com.hujiang.project.zhgd.jpush.api.push.PushClient;
...
public class JPushClient {
     ...
     * @throws APIRequestException if a request exception occurs.
     */
    public JPushScheduleResult createSingleSchedule(String name, String time, PushPayload push)
            throws APIConnectionException, APIRequestException {
     ...
     * @throws APIRequestException if a request exception occurs.
     */
    public JPushScheduleResult createDailySchedule(String name, String start, String end, String time, PushPayload push)
            throws APIConnectionException, APIRequestException {
     ...
     * @throws APIRequestException if a request exception occurs.
     */
    public JPushScheduleResult createDailySchedule(String name, String start, String end, String time, int frequency, PushPayload push)
            throws APIConnectionException, APIRequestException {
     ...
     * @throws APIRequestException if a request exception occurs.
     */
    public JPushScheduleResult createWeeklySchedule(String name, String start, String end, String time, Week[] days, PushPayload push)
            throws APIConnectionException, APIRequestException {
     ...
     * @throws APIRequestException if a request exception occurs.
     */
    public JPushScheduleResult createWeeklySchedule(String name, String start, String end, String time, int frequency, Week[] days, PushPayload push)
            throws APIConnectionException, APIRequestException {
        Preconditions.checkArgument(null != days && days.length > 0, "The days must not be empty.");
     ...
     * @throws APIRequestException if a request exception occurs.
     */
    public JPushScheduleResult createMonthlySchedule(String name, String start, String end, String time, String[] points, PushPayload push)
            throws APIConnectionException, APIRequestException {
     ...
     * @throws APIRequestException if a request exception occurs.
     */
    public JPushScheduleResult createMonthlySchedule(String name, String start, String end, String time, int frequency, String[] points, PushPayload push)
            throws APIConnectionException, APIRequestException {
        Preconditions.checkArgument(null != points && points.length > 0, "The points must not be empty.");
     ...
     * @throws APIRequestException if a request exception occurs.
     */
    public JPushScheduleResult getSchedule(String scheduleId)
            throws APIConnectionException, APIRequestException {
     ...
     * @throws APIRequestException if a request exception occurs.
     */
    public JPushScheduleResult updateScheduleName(String scheduleId, String name)
            throws APIConnectionException, APIRequestException {
        SchedulePayload payload = SchedulePayload.newBuilder()
                .setName(name)
                .build();
     ...
     * @throws APIRequestException if a request exception occurs.
     */
    public JPushScheduleResult enableSchedule(String scheduleId)
            throws APIConnectionException, APIRequestException {
        SchedulePayload payload = SchedulePayload.newBuilder()
                .setEnabled(true)
                .build();
     ...
     * @throws APIRequestException if a request exception occurs.
     */
    public JPushScheduleResult disableSchedule(String scheduleId)
            throws APIConnectionException, APIRequestException {
        SchedulePayload payload = SchedulePayload.newBuilder()
                .setEnabled(false)
                .build();
     ...
     * @throws APIRequestException if a request exception occurs.
     */
    public JPushScheduleResult updateScheduleTrigger(String scheduleId, TriggerPayload trigger)
            throws APIConnectionException, APIRequestException {
        SchedulePayload payload = SchedulePayload.newBuilder()
                .setTrigger(trigger)
                .build();
     ...
     * @throws APIRequestException if a request exception occurs.
     */
    public JPushScheduleResult updateSchedulePush(String scheduleId, PushPayload push)
            throws APIConnectionException, APIRequestException {
        SchedulePayload payload = SchedulePayload.newBuilder()
                .setPush(push)
                .build();
     ...
     * @throws APIRequestException if a request exception occurs.
     */
    public JPushScheduleResult updateSchedule(String scheduleId, SchedulePayload payload)
            throws APIConnectionException, APIRequestException {
    ...
    private JPushScheduleResult createPeriodicalSchedule(String name, String start, String end, String time,
