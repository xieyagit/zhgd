...
//        testGetSchedule();
    ...
    public static void testCreateSingleSchedule() {
        ...
        try {
            JPushScheduleResult result = jpushClient.createSingleSchedule(name, time, push);
    ...
    public static void testCreateDailySchedule() {
        ...
        try {
            JPushScheduleResult result = jPushClient.createDailySchedule(name, start, end, time, push);
            LOG.info("schedule result is " + result);
        } catch (APIConnectionException e) {
            LOG.error("Connection error. Should retry later. ", e);
        } catch (APIRequestException e) {
    ...
    public static void testCreateWeeklySchedule() {
        ...
        try {
            JPushScheduleResult result = jPushClient.createWeeklySchedule(name, start, end, time, days, push);
            LOG.info("schedule result is " + result);
        } catch (APIConnectionException e) {
            LOG.error("Connection error. Should retry later. ", e);
        } catch (APIRequestException e) {
    ...
    public static void testCreateMonthlySchedule() {
        ...
        try {
            JPushScheduleResult result = jPushClient.createMonthlySchedule(name, start, end, time, points, push);
            LOG.info("schedule result is " + result);
        } catch (APIConnectionException e) {
            LOG.error("Connection error. Should retry later.", e);
        } catch (APIRequestException e) {
    ...
    public static void testGetScheduleList() {
        ...
        try {
            ...
            for(JPushScheduleResult s : list.getSchedules()) {
                LOG.info(s.toString());
            }
        } catch (APIConnectionException e) {
            LOG.error("Connection error. Should retry later. ", e);
    ...
    public static void testGetSchedule() {
        ...
        try {
            JPushScheduleResult result = jpushClient.getSchedule(scheduleId);
