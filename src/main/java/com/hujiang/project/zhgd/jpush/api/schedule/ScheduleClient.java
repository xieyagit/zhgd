package com.hujiang.project.zhgd.jpush.api.schedule;
...
public class ScheduleClient {
    ...
    public JPushScheduleResult createSchedule(SchedulePayload payload) throws APIConnectionException, APIRequestException {
        ...
        return JPushScheduleResult.fromResponse(response, JPushScheduleResult.class);
    }
    ...
    public JPushScheduleResult getSchedule(String scheduleId) throws APIConnectionException, APIRequestException{
    ...
    public ScheduleMsgIdsResult getScheduleMsgIds(String scheduleId) throws APIConnectionException, APIRequestException{
        ...
        return JPushScheduleResult.fromResponse(response, ScheduleMsgIdsResult.class);
    }

    public JPushScheduleResult updateSchedule(String scheduleId, SchedulePayload payload) throws APIConnectionException, APIRequestException{
