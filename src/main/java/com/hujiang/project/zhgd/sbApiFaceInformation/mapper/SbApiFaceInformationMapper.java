package com.hujiang.project.zhgd.sbApiFaceInformation.mapper;
 ...
 * @date 2019-07-01
 */
public interface SbApiFaceInformationMapper 
{
	/**
     * 查询考勤人脸信息
     * 
     ...
     * @return 结果
     */
	public int deleteSbApiFaceInformationById(Integer id);
