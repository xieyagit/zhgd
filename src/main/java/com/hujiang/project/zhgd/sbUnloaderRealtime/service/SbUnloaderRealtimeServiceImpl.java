...
public class SbUnloaderRealtimeServiceImpl implements ISbUnloaderRealtimeService 
{
	...
	@Override
	public List<ExportUnloaderRealtime> getSbUnloaderRealtimeListByIds(String[] ids,String deviceId) {
		return sbUnloaderRealtimeMapper.getSbUnloaderRealtimeListByIds(ids,deviceId);
	}
