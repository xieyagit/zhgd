package com.hujiang.project.zhgd.hjWorkersInformation.mapper;
...
public interface HjWorkersInformationMapper 
{
	/**
     * 查询工人信息
     * 
     ...
     * @return 结果
     */
	public int deleteHjWorkersInformationById(Integer id);
	 ...
	 * 查看详情
	 * */
	public HjWorkersInformation sele(@Param("userId") Integer userId);
	 ...
	 *   修改证件是否齐全
	 * */
	public int updatematerial(@Param("id") Integer id);
	public int updatematerials(@Param("userId") Integer userId);
	...
	/** 查询班组*/
	public List<HjWorkersInformation> team(@Param("projectId")Integer projectId);
	/** 查询工种*/
	public List<HjWorkersInformation> dictionaries(@Param("projectId")Integer projectId);
	/** 查询单位*/
	public List<HjWorkersInformation> company(@Param("projectId")Integer projectId);
}