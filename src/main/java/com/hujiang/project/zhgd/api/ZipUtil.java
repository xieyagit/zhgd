...
public class ZipUtil {
    ...
    public static void main(String[] args) {
        new File("E:\\workspace\\ZHGD\\user-consumer-01\\target\\classes\\static\\upload\\进场合同20190606190144.zip").delete();
//        List<String> oldResPath = new ArrayList<String>();
//        // excel文件路径
//        oldResPath.add("E:\\workspace\\ZHGD\\user-consumer-01\\target\\classes\\static\\upload\\temp\\1559735330890.pdf");
//        oldResPath.add("E:\\workspace\\ZHGD\\user-consumer-01\\target\\classes\\static\\upload\\temp\\1559735331132.pdf");
