...
import com.hujiang.project.zhgd.moredian.moredianAttendanceRecord.api.MoredianAttendanceRecordApi;
...
public class api {
    ...
    @Autowired
    private MoredianAttendanceRecordApi moredianAttendanceRecordApi;
    @Autowired
...
//        return (Map<String, Object>)restTemplateUtil.Post(map, Constants.SERVICE_NAME+"/provider/constructionCompanyApi/selectConstructionCompany");
    ...
    public AjaxResult record(HttpServletRequest request, @RequestBody String json)throws Exception{
    ...
    public JSONObject getCraneHxzId(@RequestParam(value = "projectId")int projectId){
        return appCraneAddRecordApi.kanbangetCraneHxzId(projectId);
    }
