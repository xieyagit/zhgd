...
@Component
public class DeeppitPushData extends BaseSmsMessage<DeeppitPushData> {

    //基坑模块权限
    private static final  int DEEPPITPRIVILEGE=20;
    //短信模板ID
    ...
    public DeeppitPushData(){
        super();
        setPrivilegesId(DEEPPITPRIVILEGE);
    }
