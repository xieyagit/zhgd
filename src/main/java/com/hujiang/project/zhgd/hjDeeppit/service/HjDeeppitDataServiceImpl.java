...
public class HjDeeppitDataServiceImpl implements IHjDeeppitDataService
{
    ...
    public List<HjDeeppitData> selectHjDeeppitDataByTime(String types) {
        return hjDeeppitDataMapper.selectHjDeeppitDataByTimeByType(types);
    }
    ...
    @Override
    public List<HjDeeppitData> selectToDay(Integer factorId, String date, String types ) {
        return hjDeeppitDataMapper.selectToDay(factorId, date, types);
    }
