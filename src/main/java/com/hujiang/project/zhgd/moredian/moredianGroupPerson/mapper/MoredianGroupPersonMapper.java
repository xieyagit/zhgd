package com.hujiang.project.zhgd.moredian.moredianGroupPerson.mapper;
 ...
 * @date 2019-05-09
 */
public interface MoredianGroupPersonMapper 
{
	/**
     * 查询群组人员信息
     * 
     ...
     * @return 结果
     */
	public int deleteMoredianGroupPersonById(Integer id);
