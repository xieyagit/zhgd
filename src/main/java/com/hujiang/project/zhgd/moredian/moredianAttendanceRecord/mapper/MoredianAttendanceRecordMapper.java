package com.hujiang.project.zhgd.moredian.moredianAttendanceRecord.mapper;
 ...
 * @date 2019-05-14
 */
public interface MoredianAttendanceRecordMapper 
{
	/**
     * 查询考勤记录信息
     * 
     ...
     * @return 结果
     */
	public int deleteMoredianAttendanceRecordById(Integer id);
