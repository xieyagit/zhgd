package com.hujiang.project.zhgd.hjProjectPersonnelSynchronization.mapper;
 ...
 * @date 2019-05-16
 */
public interface HjProjectPersonnelSynchronizationMapper 
{
	/**
     * 查询项目人员同步信息
     * 
     ...
     * @return 结果
     */
	public int deleteHjProjectPersonnelSynchronizationById(Integer id);
