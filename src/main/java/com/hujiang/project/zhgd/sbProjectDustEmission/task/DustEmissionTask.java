...
public class DustEmissionTask extends AutoTaskBase {
    ...
    public void add()throws Exception {
        ...
        for (SbProjectDustEmission p : projectDustEmissions) {
            ...
            if(list.size() > 0 && (list.size() == 50 || count == projectDustEmissions.size())) { //最多每50条发送一次消息                JmsMessageInfo<List<SbDustEmission>> messageInfo = new JmsMessageInfo<List<SbDustEmission>>();
