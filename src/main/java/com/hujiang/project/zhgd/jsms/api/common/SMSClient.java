package com.hujiang.project.zhgd.jsms.api.common;
...
import com.hujiang.project.zhgd.jsms.api.account.AccountBalanceResult;
import com.hujiang.project.zhgd.jsms.api.account.AppBalanceResult;
import com.hujiang.project.zhgd.jsms.api.common.model.BatchSMSPayload;
import com.hujiang.project.zhgd.jsms.api.common.model.BatchSMSResult;
import com.hujiang.project.zhgd.jsms.api.schedule.model.JSMSScheduleResult;
import com.hujiang.project.zhgd.jsms.api.schedule.model.ScheduleSMSPayload;
import com.hujiang.project.zhgd.jsms.api.template.SendTempSMSResult;
import com.hujiang.project.zhgd.jsms.api.template.TempSMSResult;
import com.hujiang.project.zhgd.jsms.api.template.TemplatePayload;
...
import com.hujiang.project.zhgd.jsms.api.SendSMSResult;
import com.hujiang.project.zhgd.jsms.api.ValidSMSResult;
import com.hujiang.project.zhgd.jsms.api.common.model.SMSPayload;
...
public class SMSClient {
     ...
     * @throws APIRequestException request exception
     */
	public JSMSScheduleResult sendScheduleSMS(ScheduleSMSPayload payload) throws APIConnectionException, APIRequestException {
        ...
        return JSMSScheduleResult.fromResponse(responseWrapper, JSMSScheduleResult.class);
    }
     ...
     * @throws APIRequestException request exception
     */
    public JSMSScheduleResult updateScheduleSMS(ScheduleSMSPayload payload, String scheduleId)
            throws APIConnectionException, APIRequestException {
        Preconditions.checkArgument(null != payload, "Schedule SMS payload should not be null");
     ...
     * @throws APIRequestException request exception
     */
    public JSMSScheduleResult getScheduleSMS(String scheduleId) throws APIConnectionException, APIRequestException {
        Preconditions.checkArgument(null != scheduleId, "Schedule id should not be null");
