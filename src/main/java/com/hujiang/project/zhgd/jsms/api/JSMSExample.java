...
import com.hujiang.project.zhgd.jsms.api.common.SMSClient;
...
import com.hujiang.project.zhgd.jsms.api.common.model.RecipientPayload;
...
public class JSMSExample {
    ...
    private static final String appkey = "0c578ef6b15297568e54bb0b";
    private static final String masterSecret = "e09d65cb1daf863ba1f585ab";
...
//        testSendTemplateSMS();
     ...
     * 发送单条短信
     */
	public static void testSendTemplateSMS(String mobileNumber,int tempId,
                                           Map<String, String> tempPara) {
	    SMSClient client = new SMSClient(masterSecret, appkey);
        SMSPayload payload = SMSPayload.newBuilder()
    ...
    public static void testSendScheduleSMS() {
        ...
        ScheduleSMSPayload payload = ScheduleSMSPayload.newBuilder()
                ...
                .build();
        try {
            JSMSScheduleResult result = client.sendScheduleSMS(payload);
    ...
    public static void testUpdateScheduleSMS() {
        ...
        ScheduleSMSPayload payload = ScheduleSMSPayload.newBuilder()
                ...
                .build();
        try {
            JSMSScheduleResult result = client.updateScheduleSMS(payload, "dsfd");
            LOG.info(result.toString());
        } catch (APIConnectionException e) {
            LOG.error("Connection error. Should retry later. ", e);
        } catch (APIRequestException e) {
