    ...
    <div id="systemSchedule">
        ...
        <div class="side-nav">
            <ul>
                ...
                <li @click="isActiveShow('/systemSchedule_home')">
                    <router-link to="/systemSchedule_home" :class="activeShow=='/systemSchedule_home'||activeShow=='/systemSchedule'?'active':''">
                        <div class="icon home"></div>
                        <span>首页</span>
                    </router-link>
                </li>
                <li @click="isActiveShow('/systemSchedule_control')">
                    <router-link to="/systemSchedule_control" :class="activeShow=='/systemSchedule_control'?'active':''">
                        <div class="icon control"></div>
                        <span>总控计划</span>
                    </router-link>
                </li>
                <li @click="isActiveShow(`/systemSchedule_plan`)">
                    <router-link to="/systemSchedule_plan" :class="activeShow=='/systemSchedule_plan'?'active':''">
            ...
            ul {
                ...
                li {
                    ...
                    a {
                        ...
                        .plan {
                            background-image: url('../../../../static/images/system-plan.png');
                        }
                        .control {
                            background-image: url('../../../../static/images/system-control.png');
                        }
                        span {
                            // width: .8rem;
                            vertical-align: top;
...
export default {
    data() {
        return {
            ...
            activeShow: '/systemSchedule_home', // 当前选中模块
        }
    },
    created() {
        this.getPath()
